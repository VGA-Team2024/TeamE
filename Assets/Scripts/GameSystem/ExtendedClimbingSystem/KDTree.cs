...
//	Recursively search the tree.
	...
	public List<int> FindNearestEpsilon(Vector3 pt, List<int> resultBuffer) //Use result buffer to avoid garbage collection.
	{
		resultBuffer.Clear();
		float bestSqDist = 1000000000f;
		int bestIndex = -1;
	...
	void SearchEpsilon(Vector3 pt, ref float bestSqSoFar, ref int bestIndex, List<int> resultBuffer)
	{
		float mySqDist = (pivot - pt).sqrMagnitude;
